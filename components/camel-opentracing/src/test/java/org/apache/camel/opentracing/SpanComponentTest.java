...
public class SpanComponentTest extends CamelOpenTracingTestSupport {
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("seda:a").routeId("a")
                        ...
                        .to("opentracing-span:setBaggage?spanKey=a-baggage&valueHeader=request-header")
                        .to("seda:b")
                        .delay(2000)
                        .to("seda:c")
                        .log("End of routing");
                ...
                from("seda:b").routeId("b")
                        .log("routing at ${routeId}")
                        .to("opentracing-span:tag?spanKey=b-tag&valueHeader=request-header")
                        .delay(simple("${random(1000,2000)}"));

                from("seda:c").routeId("c")
                        .to("log:test")
                        .to("opentracing-span:getBaggage?spanKey=a-baggage&valueHeader=baggage-header")
